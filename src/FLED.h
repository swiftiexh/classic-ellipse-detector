...
public:// Draw Data and Write Information Functions
	...
	void writeDetectionsTable(const string &filepath);
	void exportDebugArtifacts(const string &outputDir, const Mat &sourceGray, const cv::Vec<double, 10> *detDetailTime = nullptr);
